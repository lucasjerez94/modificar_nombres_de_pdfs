...
carpeta_origen = '/Users/Lucas/Downloads/Eio Gizu/ilovepdf'
carpeta_destino = '/Users/Lucas/Downloads/Eio Gizu/prueba1'
...
for archivo_pdf in archivos_pdf:
    ...
    if nombre_completo:
        nuevo_nombre = f"{nombre_completo.strip()} 3 RO.pdf"  # Agrega "3 RO" al nombre
    else:
        nuevo_nombre = f"{archivo_pdf} 3 RO"  # Agrega "3 RO" al nombre original si no se encuentra "DNI"
